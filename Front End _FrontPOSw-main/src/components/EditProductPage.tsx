...
const EditProductPage: React.FC = () => {
  ...
  // Mock data for existing product - in real app this would come from API
  ...
  const [selectedCategories, setSelectedCategories] = useState<string[]>(['Muebles']);
  ...
  const handleSave = () => {
    // Here you could add validation logic and API call to update the product
    console.log('Updating product with ID:', id, formData);
    navigate('/inventory');
  };
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="flex items-center space-x-3">
              ...
              <button 
                onClick={handleSave}
                className="bg-primary hover:bg-primary-600 text-black font-medium px-6 py-2 rounded-lg transition-colors"
              >
                Guardar cambios
              </button>
            </div>
